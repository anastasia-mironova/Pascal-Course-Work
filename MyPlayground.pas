...
type
  Playground = class
    ...
    constructor Create(x1: integer; y1: integer; x2: integer; y2: integer; CellSize: integer);
...
constructor Playground.Create(x1: integer; y1: integer; x2: integer; y2: integer; CellSize: integer);
begin
  Self.x1 := x1;
  Self.y1 := y1;
  Self.x2 := x2;
  ...
  snake := MySnake.Snake.Create(Columns() div 2,Rows() div 2);
...
begin
  for var i := 1 to snake.queue.length - 1 do 
  begin
